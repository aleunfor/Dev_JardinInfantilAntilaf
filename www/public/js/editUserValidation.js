$(function () {
    ...
    $("form[name='formEditUser']").validate({
        ...
        messages: {
            ...
            id_tipousuario: "<div class='alert alert-warning w-100' role='alert'>Ingrese Rol ! </div>",
            activado: "<div class='alert alert-warning w-100' role='alert'>Usuario Activo (Si/No) ! </div>"
        },
